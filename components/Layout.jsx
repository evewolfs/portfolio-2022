...
<br/>
          ...
          {children}
          <div className="footer">this website was developed with next.js & react.js - <a href="https://github.com/evewolfs/portfolio-2022" target="_blank" ><span>see on my github</span></a></div>
        </motion.div>
      </div>
    </>
  );
